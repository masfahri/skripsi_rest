...
--
-- Host: localhost:3306
-- Generation Time: Apr 12, 2019 at 12:02 PM
...
CREATE TABLE `token` (
  ...
  `user_id` int(11) NOT NULL,
  `token` text NOT NULL,
  `status` set('aktivasi','lupa_password','pembayaran','') NOT NULL,
...
CREATE TABLE `users` (
  ...
  `status` set('aktif','pending','not_aktif','admin') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `users` (`id`, `username`, `email`, `nama`, `nomor_hp`, `alamat`, `created_at`, `updated_at`, `status`) VALUES
(16, NULL, 'admin@demo.com', '', '123', '', '2019-04-09 02:57:26', '2019-04-11 11:57:54', 'admin'),
(17, NULL, 'user@demo.com', '', '081898765431', '', '2019-04-09 02:59:06', '2019-04-09 15:43:01', 'not_aktif'),
(18, NULL, 'hsefakhri@gmail.com', '', '085883518288', '', '2019-04-09 03:06:36', '2019-04-11 13:28:23', 'aktif'),
(64, NULL, 'saya.masfahri@gmail.com', '', '081807593006', '', '2019-04-10 22:39:13', '2019-04-11 12:14:06', 'admin');
